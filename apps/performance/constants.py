PERFORMANCE_ATTRIBUTES = [
    ("Helyezkedés / üres terület keresése", "finding_space", "Finding space"),
    ...
    ("Labdavesztés utáni reakció", "reaction_to_losing_ball", "Reaction"),

    ("Labdakontroll", "ball_control", "Ball control"),
    ("Nyomás alatti átvétel", "receiving_under_pressure", "Receiving"),
    ...
    ("Támadó fejelés kapura", "attacking_heading", "Attacking heading"),
    ("Beadás", "crossing", "Crossing"),
    ("Befejezés", "finishing", "Finishing"),

    ("1v1 védekezés", "hard_to_beat", "Hard to beat"),
    ("Védekező fejjáték", "defensive_heading", "Defensive heading"),
    ...
    ("Bátorság labda nélkül", "bravery_without_ball", "Bravery without ball"),
    ("Érzelemkontroll", "control", "Control"),
